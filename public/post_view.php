...
if (empty($_SESSION['user_logged_in'])) {
    echo "<script>alert('⚠ You are not logged in. Please login to read full newsletter.');window.location='login.php';</script>";
    exit;
}
?>
...
<head>
  ...
  <!-- ✅ Bootstrap Icons (for person-circle, bell etc.) -->
<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">

<!-- ✅ Bootstrap Bundle with Popper (dropdown ke liye) -->
